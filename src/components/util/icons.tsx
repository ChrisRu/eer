...
export const CrossIcon = ({ title, className, ...props }: IIcon) => (
  <div
    {...props}
    className={cx('icon icon--cross', className)}
    title={title || 'Close'}>
    <span />
    <span />
  </div>
...
export const CheckIcon = ({ title, className, ...props }: IIcon) => (
  <svg
    ...
    viewBox="0 0 512 512"
    className={cx('icon icon--check', className)}>
...
export const UncheckIcon = ({ title, className, ...props }: IIcon) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    className={cx('icon icon--uncheck', className)}>
...
export const LoadingIcon = ({ title, className, ...props }: IIcon) => (
  <div
    {...props}
    className={cx('icon icon--loading', className)}
    title={title || 'Loading'}>
